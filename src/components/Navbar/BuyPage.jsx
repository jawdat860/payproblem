...
function BuyPage() {
  ...
  return (
    ...
    <div>
      <button
        className={`bg-gradient-to-r flex items-center relative rounded-full w-[100%] justify-center from-primary to-secondary hover:scale-105 duration-200 text-white py-2 px-2 flex items-center gap-3 ${classes.button}`}
